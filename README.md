Some basic and complete examples of flink stream applications. Complete in the sense that `build.sbt` has all the necessary libraries and version, imports are set correctly and code compiles.
